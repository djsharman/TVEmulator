...
unsigned char tvParams::getGamma(size_t postition) {
    unsigned char gamma8 = tvParams::gamma8[postition];
    return gamma8;
} 

unsigned char tvParams::getColor(size_t postition) {
    unsigned char color = tvParams::colors[postition];
    return color;
}

unsigned int tvParams::getGammaSize() {
    return tvParams::gamma8.size();
}

unsigned int tvParams::getColorSize() {
    return tvParams::colors.size();
}

std::vector <unsigned char> tvParams::gamma8 = {
 ...
 std::vector <unsigned char> tvParams::colors = {
